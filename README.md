# Информация
В репозитории содержатся лабораторные работы по курсу предмета "Основы алгоритмизации и программирования", а так же файлы. Семестр №1 - ВМСиС.

Работы принимала Желтко Ю.Ю.

> Запомни! Долги превращаются в боль.
## Содержание
...
3. [Подготовка к экзамену](#Условия-лабораторных-работ)
